...
class Behavior {
 ...
 public:
  ...
  void setFrontUs(opendlv::proxy::DistanceReading const &) noexcept;
  void setRearUs(opendlv::proxy::DistanceReading const &) noexcept;
  void setLeftIr(opendlv::proxy::DistanceReading const &) noexcept;
  void setRightIr(opendlv::proxy::DistanceReading const &) noexcept;
  void step(float time, bool VERBOSE) noexcept;

 private:
  opendlv::proxy::DistanceReading m_frontUsReading;
  opendlv::proxy::DistanceReading m_rearUsReading;
  ...
  std::mutex m_frontUsReadingMutex;
  std::mutex m_rearUsReadingMutex;
