...
class SingleTrackModel {
 ...
 public:
  void setLeftAxleAngularVelocity(opendlv::proxy::AxleAngularVelocityRequest const &) noexcept;
  void setRightAxleAngularVelocity(opendlv::proxy::AxleAngularVelocityRequest const &) noexcept;
